defmodule Proxy.Validator do
  ...
  @doc "Returns {:attack, pattern} or :ok. Checks all string values in parallel."
  ...
  defp check_input(value) when is_binary(value) do
    Enum.find_value(@all_patterns, :ok, fn pattern ->
      if Regex.match?(pattern, value), do: {:attack, inspect(pattern)}
    end)
  end
